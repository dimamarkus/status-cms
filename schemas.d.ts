...
export interface ApiBotBot extends CollectionTypeSchema {
  info: {
    singularName: 'bot';
    pluralName: 'bots';
    displayName: 'Bot';
  ...
  attributes: {
    ...
    avatar: MediaAttribute;
    user_id: RelationAttribute<'api::bot.bot', 'oneToOne', 'admin::user'>;
    ai_model: EnumerationAttribute<
      [
        'gpt-3.5-turbo',
        'text-davinci-003',
        'text-curie-001',
    ...
    >;
    name: StringAttribute;
    temperature: DecimalAttribute &
      SetMinMax<{
        min: 0;
        max: 1;
      }> &
      DefaultTo<0.75>;
    max_tokens: BigIntegerAttribute &
      SetMinMax<{
        min: '1';
        max: '2048';
      }> &
      DefaultTo<'250'>;
    top_p: DecimalAttribute &
      SetMinMax<{
        min: 1;
        max: 0;
      }> &
      DefaultTo<0.5>;
    frequency_penalty: DecimalAttribute &
      SetMinMax<{
        min: 0;
        max: 0;
      }> &
      DefaultTo<0>;
    presence_penalty: DecimalAttribute &
      SetMinMax<{
        min: 2;
        max: 0;
      }> &
      DefaultTo<0>;
    welcome_message: TextAttribute &
      SetMinMaxLength<{
        minLength: 5;
        maxLength: 300;
      }> &
      DefaultTo<'Hello. How can I help you today?'>;
    createdAt: DateTimeAttribute;
    updatedAt: DateTimeAttribute;
    publishedAt: DateTimeAttribute;
    createdBy: RelationAttribute<'api::bot.bot', 'oneToOne', 'admin::user'> &
      PrivateAttribute;
    updatedBy: RelationAttribute<'api::bot.bot', 'oneToOne', 'admin::user'> &
      PrivateAttribute;
  };
}
